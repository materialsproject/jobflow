...
activities is still in development, so at the moment we
do not have a dedicated help forum. For the time being, please
submit questions and bugs to the
`GitHub issues page <https://github.com/hackingmaterials/activities/issues>`__.
...
contributors `here
<https://hackingmaterials.github.io/activities/contributors.html>`__.
